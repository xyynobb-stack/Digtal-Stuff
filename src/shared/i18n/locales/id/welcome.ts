export default {
  title: "Selamat datang di JingYuAI",
  subtitle:
  ...
  dividerOr: "atau",
  connectRemote: "Hubungkan ke JingYuAI Remote",
  connectRemoteTitle: "Hubungkan ke JingYuAI Remote",
  connectRemoteSubtitle:
    "Masukkan URL server JingYuAI API yang sedang berjalan.",
