...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on JingYu Agent, the JingYuAI desktop assistant. When the user needs help with "
    "JingYu Agent itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "the installed JingYu Agent guidance is your "
...
STEER_CHANNEL_NOTE = (
    ...
    "While you work, the user can send an out-of-band message that JingYu Agent "
...
PLATFORM_HINTS = {
    ...
    "desktop": (
        "You are chatting inside the JingYu Agent desktop app — a graphical chat "
...
# container / remote host rather than on the machine where JingYu Agent itself
    ...
    if not is_remote_backend:
        ...
        if probe:
            hints.append(
                ...
                f"where JingYu Agent itself is running. The host OS, home, and cwd "
                f"of the JingYu Agent process are irrelevant; only the following "
            ...
            hints.append(
                f"Terminal backend: {backend}. Your `terminal`, `read_file`, "
                f"`write_file`, `patch`, and `search_files` tools all operate "
                f"inside {description} — NOT on the machine where JingYu Agent "
