export default {
  ...
  dashscopeDesc: "透過阿里雲百鍊 / DashScope 使用千問模型",
  dashscopeEndpoint: "DashScope 節點",
  dashscopeChinaEndpoint: "中國大陸",
  dashscopeIntlEndpoint: "國際版",
  dashscopeApiKey: "阿里雲百鍊 DashScope API Key",
  dashscopeHint: "用於阿里雲百鍊 / DashScope 千問模型",
