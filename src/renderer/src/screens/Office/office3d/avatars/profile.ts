...
const pick = <T>(values: readonly T[], index: number) =>
...
export const createAgentAvatarProfileFromSeed = (
  seed: string,
): AgentAvatarProfile => {
...
export const createDefaultAgentAvatarProfile = (
  seed: string,
): AgentAvatarProfile => createAgentAvatarProfileFromSeed(seed);
