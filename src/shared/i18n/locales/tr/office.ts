export default {
  ...
  setupDesc1:
    "Claw3D, JingYuAI ajanlarınız için 3B görselleştirme ortamıdır. Ajanlarınızı interaktif bir ofis alanında çalışırken görmenizi sağlar.",
  setupDesc2:
  ...
  repStatusSignedOut: "Bankayı kullanmak için JingYuAI hesabınıza giriş yapın.",
  repStatusUnlinked:
  ...
  repStatusForeign: "Bu ajan farklı bir JingYuAI hesabına bağlı.",
} as const;
