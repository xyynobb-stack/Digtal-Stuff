export default {
  ...
  analytics: {
    ...
    hint: "تُجمع بشكل مجهول وتُستخدم فقط لتحسين JingYuAI — أبداً محادثاتك أو ملفاتك أو أوامرك أو أي بيانات شخصية.",
  },
  notDetected: "لم يتم الكشف",
  updatedSuccessfully: "تم التحديث بنجاح!",
  updateSuccess: "تم تحديث JingYuAI بنجاح.",
  ...
  poolHint:
    "أضف مفاتيح API متعددة لنفس المزوّد للتدوير التلقائي وتوزيع الحمل. سيتنقل JingYuAI بينها.",
  add: "إضافة",
  remove: "إزالة",
  keyLabel: "المفتاح",
  empty: "(فارغ)",
  dataSection: "البيانات",
  dataHint: "تصدير أو استيراد إعدادات JingYuAI وجلساته ومهاراته وذاكرته.",
  ...
  autoUpgradeDesktopHint:
    "تنزيل إصدارات JingYuAI الجديدة من GitHub تلقائياً عند بدء التطبيق. أوقف هذا لإظهار زر الترقية عند بدء التشغيل دون تنزيل حتى تنقر عليه.",
  ...
  migrationDesc:
    "تم العثور على OpenClaw في <code>{{path}}</code>. يمكنك ترحيل إعداداتك ومفاتيح API وجلساتك ومهاراتك إلى JingYuAI.",
  migrationDismiss: "عدم الإظهار مرة أخرى",
  migrating: "جارٍ الترحيل...",
  migrateToHermes: "الترحيل إلى JingYuAI",
  skip: "تخطي",
  ...
  modeLocal: "محلي",
  modeRemote: "عن بُعد",
  modeLocalHint: "استخدام JingYuAI المثبت على هذا الجهاز",
  modeRemoteHint: "الاتصال بخادم JingYuAI API على شبكتك أو السحابة",
  remoteUrl: "الرابط البعيد",
  remoteUrlHint:
    "رابط خادم JingYuAI API (يجب أن يعرض /health و /v1/chat/completions)",
  remoteApiKey: "*** البعيد",
  remoteApiKeyHint:
  ...
  serverConfigHint:
    "أنت متصل بخادم JingYuAI عن بُعد. اختيار النموذج ومفاتيح API للمزوّدين وبيانات الاعتماد تُدار في <code>~/.hermes/.env</code> و <code>config.yaml</code> على الخادم. حرّرها على المضيف (مثال: <code>docker exec -it hermes vi /opt/data/.env</code>) وأعد تشغيل الحاوية.",
  ...
  communityHint:
    "انضم إلى قناة Discord لدينا لطرح الأسئلة والإبلاغ عن المشكلات والتحدث مع مستخدمي JingYuAI الآخرين.",
  joinDiscord: "الانضمام إلى قناة Discord",
  communityLinksHint:
    "تواصل مع مجتمع JingYuAI، واحصل على المساعدة، وابق على اطلاع.",
  linkWebsite: "الموقع",
  linkDiscord: "Discord",
  linkX: "X",
  ...
  supportHint:
    "JingYuAI مجاني ومفتوح المصدر — إذا كان مفيداً لك، فكر في دعم تطويره.",
  supportKofi: "الدعم على Ko-fi",

  // SSH & Server Config
  modeSsh: "نفق SSH",
  modeSshHint:
    "نفق إلى JingYuAI عن بُعد عبر SSH — بدون منافذ مكشوفة أو مفاتيح API مطلوبة.",
  ...
  remoteEnvDesc:
    "الوضع البعيد: أضف API_SERVER_KEY=<مفتاحك> إلى ملف .env على خادم JingYuAI البعيد، ثم أعد تشغيل البوابة.",
  sshHost: "مضيف SSH",
  sshPort: "منفذ SSH",
  sshUsername: "اسم المستخدم",
  sshKeyPath: "مسار المفتاح الخاص",
  sshKeyPathOptional: "(اختياري، الافتراضي ~/.ssh/id_rsa)",
  sshRemotePort: "منفذ JingYuAI البعيد",
  ...
  sshErrorConnection:
    "تعذر الاتصال عبر SSH أو الوصول إلى JingYuAI عن بُعد. تأكد من:\\n• مفتاح SSH صحيح (أو ~/.ssh/id_rsa الافتراضي يعمل)\\n• بوابة JingYuAI تعمل على الجهاز البعيد\\n• المنفذ البعيد صحيح (الافتراضي 8642)",
