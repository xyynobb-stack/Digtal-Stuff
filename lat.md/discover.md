...
The `project-manager` starter routes semantically similar questions into company-specific playbooks distilled from the internal questionnaire. Distinctive operating rules appear before generic project mechanics; morning meetings, quality-delivery meetings, decision disputes, attendance, and five customer-response cases have separate routes, with direct, synthesized, and safety provenance labels.
