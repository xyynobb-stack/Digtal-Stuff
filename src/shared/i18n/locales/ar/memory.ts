export default {
  title: "الذاكرة",
  subtitle: "ما يتذكره JingYuAI عنك وعن بيئتك عبر الجلسات.",
  sessions: "الجلسات",
  messages: "الرسائل",
  memories: "الذكريات",
  ...
  noMemoriesYet:
    "لا توجد ذكريات بعد. سيحفظ JingYuAI الحقائق المهمة أثناء المحادثة.",
  ...
  userProfileHint:
    "أخبر JingYuAI عن نفسك — الاسم، الدور، التفضيلات، أسلوب التواصل.",
  providersHint:
    "مزوّدو الذاكرة القابلون للتوصيل يمنحون JingYuAI ذاكرة طويلة المدى متقدمة. الذاكرة المدمجة (أعلاه) نشطة دائماً بجانب المزوّد المختار.",
