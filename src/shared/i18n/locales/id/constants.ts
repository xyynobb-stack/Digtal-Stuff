export default {
  ...
  dashscopeDesc: "Model Qwen melalui DashScope",
  dashscopeEndpoint: "Endpoint DashScope",
  dashscopeChinaEndpoint: "Tiongkok Daratan",
  dashscopeIntlEndpoint: "Internasional",
  dashscopeApiKey: "Alibaba DashScope API Key",
  dashscopeHint: "Model Qwen melalui DashScope / Model Studio",
