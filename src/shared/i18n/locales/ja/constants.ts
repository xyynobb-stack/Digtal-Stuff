export default {
  ...
  dashscopeDesc: "DashScope 経由の Qwen モデル",
  dashscopeEndpoint: "DashScope エンドポイント",
  dashscopeChinaEndpoint: "中国本土",
  dashscopeIntlEndpoint: "国際版",
  dashscopeApiKey: "Alibaba DashScope API キー",
  dashscopeHint: "DashScope / Model Studio の Qwen モデル",
