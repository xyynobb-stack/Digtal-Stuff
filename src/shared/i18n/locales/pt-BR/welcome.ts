export default {
  ...
  dividerOr: "ou",
  connectRemote: "Conectar ao JingYuAI Remoto",
  connectRemoteTitle: "Conectar ao JingYuAI Remoto",
  connectRemoteSubtitle:
    "Insira a URL de um servidor da API do JingYuAI em execução.",
