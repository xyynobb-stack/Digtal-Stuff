...
- [[discover]] — the employee-facing Discover categories and the placeholder entry for browsing future writing templates.
...
- [[onboarding]] — the shared cinematic first-run chrome with the JingYuAI icon's centre-to-slot flight and the Welcome / Install screens built on it.
