export default {
  ...
  analytics: {
    ...
    hint: "Ajuda a melhorar o JingYuAI enviando dados de uso anônimos e agregados para o serviço de análise do projeto. Você pode desativar a qualquer momento.",
    disclosure: {
      ...
      endpoint:
        "Os dados são enviados para o serviço de análise do JingYuAI (analytics.hermesone.org). Gravações de sessão e captura automática de pageviews estão desativadas.",
      notCollected:
  ...
  updateSuccess: "JingYuAI atualizado com sucesso.",
  ...
  poolHint:
    "Adicione várias chaves de API para o mesmo provedor para rotação automática e balanceamento de carga. O JingYuAI alternará entre elas.",
  add: "Adicionar",
  remove: "Remover",
  keyLabel: "Chave",
  empty: "(vazio)",
  dataSection: "Dados",
  dataHint:
    "Exporte ou importe sua configuração do JingYuAI, sessões, habilidades e memória.",
  ...
  migrationDesc:
    "Encontramos o OpenClaw em <code>{{path}}</code>. Você pode migrar sua configuração, chaves de API, sessões e habilidades para o JingYuAI.",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando o JingYuAI instalado neste dispositivo",
  modeRemoteHint:
    "Conectar a um servidor da API do JingYuAI na sua rede ou nuvem",
  remoteUrl: "URL Remota",
  remoteUrlHint:
    "A URL do servidor da API do JingYuAI (deve expor /health e /v1/chat/completions)",
  ...
  serverConfigHint:
    "Você está conectado a um servidor remoto do JingYuAI. A seleção de modelos, as chaves de API dos provedores e as credenciais são gerenciadas no host remoto em <code>~/.hermes/.env</code> e <code>config.yaml</code>. Edite-os lá e reinicie o servidor.",
  connectionMode: "Modo",
