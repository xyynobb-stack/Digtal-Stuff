export default {
  ...
  dividerOr: "או",
  connectRemote: "התחברות ל-JingYuAI מרוחק",
  connectRemoteTitle: "התחברות ל-JingYuAI מרוחק",
  connectRemoteSubtitle: "הזינו את הכתובת של שרת JingYuAI API פעיל.",
