export default {
  ...
  analytics: {
    ...
    hint: "JingYuAI'ı iyileştirmeye yardımcı olmak için anonim, toplulaştırılmış kullanım verilerini projenin analiz hizmetine gönderir. İstediğiniz zaman kapatabilirsiniz.",
    disclosure: {
      ...
      endpoint:
        "Veriler JingYuAI analiz hizmetine gönderilir (analytics.hermesone.org). Oturum kayıtları ve sayfa görüntüleme otomatik yakalaması devre dışıdır.",
      notCollected:
  ...
  updateSuccess: "JingYuAI başarıyla güncellendi.",
  ...
  poolHint:
    "Otomatik dönüşüm ve yük dengelemesi için aynı sağlayıcıya birden çok API Anahtarı ekleyin. JingYuAI bunlar arasında geçiş yapacaktır.",
  add: "Ekle",
  remove: "Kaldır",
  keyLabel: "Anahtar",
  empty: "(boş)",
  dataSection: "Veri",
  dataHint:
    "JingYuAI yapılandırmanızı, oturumlarınızı, yeteneklerinizi ve belleğinizi dışa veya içe aktarın.",
  ...
  migrationDesc:
    "<code>{{path}}</code> adresinde OpenClaw bulundu. Yapılandırmanızı, API anahtarlarınızı, oturumlarınızı ve yeteneklerinizi JingYuAI'e taşıyabilirsiniz.",
  migrationDismiss: "Tekrar gösterme",
  migrating: "Taşınıyor...",
  migrateToHermes: "JingYuAI'e Taşı",
  skip: "Geç",
  ...
  modeLocal: "Yerel",
  modeRemote: "Uzak",
  modeLocalHint: "Bu cihazda yüklü JingYuAI kullanılıyor",
  modeRemoteHint:
    "Ağınızdaki veya buluttaki bir JingYuAI API sunucusuna bağlanın",
  remoteUrl: "Uzak URL",
  remoteUrlHint:
    "JingYuAI API sunucusu URL'si (/health ve /v1/chat/completions endpoint'lerini sunmalıdır)",
  ...
  serverConfigHint:
    "Uzak bir JingYuAI sunucusuna bağlandınız. Model seçimi, sağlayıcı API anahtarları ve kimlik bilgileri sunucunun <code>~/.hermes/.env</code> ve <code>config.yaml</code> dosyalarında yönetilir. Bunları ana bilgisayarda düzenleyin (örn. <code>docker exec -it hermes vi /opt/data/.env</code>) ve kabı yeniden başlatın.",
  connectionMode: "Mod",
  ...
  communityHint:
    "Sorular sormak, sorunları bildirmek ve diğer JingYuAI kullanıcılarıyla sohbet etmek için Discord kanalımıza katılın.",
  joinDiscord: "Discord Kanalına Katıl",

  // SSH & Server Config
  modeSsh: "SSH Tüneli",
  modeSshHint:
    "SSH üzerinden uzak bir JingYuAI'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  remoteEnvDesc:
    "Uzak mod: uzak JingYuAI sunucunuzdaki .env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından gateway'i yeniden başlatın.",
  ...
  sshRemotePort: "Uzak JingYuAI Portu",
  ...
  sshErrorConnection:
    "SSH üzerinden bağlanılamadı veya uzaktaki JingYuAI'e ulaşılamadı. Şunlardan emin olun:\n• SSH anahtarı doğru (veya varsayılan ~/.ssh/id_rsa çalışıyor)\n• Uzak sunucuda JingYuAI gateway'i çalışıyor\n• Uzak port doğru (varsayılan 8642)",
