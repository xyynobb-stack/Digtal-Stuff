...
The setup and Providers screens record successfully provisioned employees locally and show each employee's phone, API real name, and available OpenAI-chat models.
