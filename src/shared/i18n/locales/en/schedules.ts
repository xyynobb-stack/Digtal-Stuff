export default {
  ...
  customTime: "Custom execution time",
  customMonth: "Month",
  customDay: "Day",
  customHour: "Hour",
  customMinute: "Minute",
  customTimeHint: "Runs every year on {{month}}/{{day}} at {{hour}}:{{minute}}",
  customTimeInvalid: "Enter a valid month, day, hour, and minute",
  prompt: "Prompt",
  promptPlaceholder: "Enter task description to be executed by the agent...",
  model: "Model",
  modelHint: "The task keeps using this model even if chat switches models.",
