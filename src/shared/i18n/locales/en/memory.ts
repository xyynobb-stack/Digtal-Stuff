export default {
  title: "Memory",
  subtitle:
    "What JingYuAI remembers about you and your environment across sessions.",
  sessions: "Sessions",
  messages: "Messages",
  memories: "Memories",
  ...
  noMemoriesYet:
    "No memories yet. JingYuAI will save important facts as you chat.",
  ...
  userProfileHint:
    "Tell JingYuAI about yourself — name, role, preferences, communication style.",
  providersHint:
    "Pluggable memory providers give JingYuAI advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
