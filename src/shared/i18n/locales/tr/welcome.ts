export default {
  ...
  dividerOr: "veya",
  connectRemote: "Uzak JingYuAI'e Bağlan",
  connectRemoteTitle: "Uzak JingYuAI'e Bağlan",
  connectRemoteSubtitle: "Çalışan bir JingYuAI API sunucusunun URL'sini girin.",
